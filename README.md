...
6. [安全注意事项](#六安全注意事项)
7. [Obsidian + AI Agent Skill 深度集成](#七obsidian--ai-agent-skill-深度集成) → [详细指南](./AI-Agent-Skill-深度集成指南.md)
8. [附录：推荐组合方案速查](#附录推荐组合方案速查)
...
> 完整内容已独立为 → **[AI Agent Skill 深度集成指南](./AI-Agent-Skill-深度集成指南.md)**

本指南覆盖：三种集成方案（文件系统直读 / MCP语义搜索 / obsidian-skills）的完整实施、知识库结构设计、5种测试知识模板、填报示例、Skill 开发与部署脚本。
...
```bash
# 1. 克隆本仓库，在 Obsidian 中打开 Testing-Knowledge-Vault/
git clone https://github.com/Mageric0412/obsidian-deploy-guide.git
...
# 3. 安装 test-design skill
cp -r obsidian-deploy-guide/Testing-Knowledge-Vault/skills/* ~/.claude/skills/
```
...
→ **完整知识库结构设计（5种模板 + 填报示例 + SKILL.md + 部署脚本）请参见 [AI Agent Skill 深度集成指南](./AI-Agent-Skill-深度集成指南.md)**
